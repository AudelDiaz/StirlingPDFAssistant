...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "admin_limit_capped": "⚠️ Telegram limits downloads to **{capped}MB**. Requested {requested}MB was capped to {capped}MB.",
    ...
    "es": {
        ...
        "admin_limit_capped": "⚠️ Telegram limita las descargas a **{capped}MB**. Los {requested}MB solicitados se redujeron a {capped}MB.",
